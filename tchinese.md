...
我一直很喜歡痲瘋劍客，但是他實在太難用了，於是我讓痲瘋去修仙，修練有成再回來
這是一個完全改變痲瘋玩法的模組，內容包含：
[list]
[*] 重置7個戰鬥技能
[*] 新增5個紮營技能
[*] 3種專屬美德和3種專屬折磨
...
生命：63 > 40       劍客脫下了重裝，成為劍仙
閃避：20 > 30       劍仙御劍飛行，閃避攻擊輕而易舉
防禦：0% > 0%       穿重裝都沒防禦，脫下也自然沒防禦
速度：4 > 10        劍仙御劍飛行，奇快無比
精準：0 > 0         仙劍攻擊難以閃躲(詳見技能基礎精準)
暴擊：5% > 5%       太超模了不能再加暴擊了
傷害：13-26 > 20-26 仙劍劍身各處幾乎一樣鋒利
[h3]初始抗性 原版痲瘋vs痲瘋劍仙[/h3]
暈眩：60% > 80%  仙人的意志力無比強大
腐蝕：40% > 50%  仙體百毒不侵！某些奇毒例外
流血：10% > 10%  仙人依然有血有肉，還是會流血
疾病：20% > 90%  仙體百病不侵！
位移：60% > 0%   站在飛劍上當然沒有位移抗性
減益：40% > 20%  仙人也會中魔法
致死：67% > 67%
陷阱：10% > 110% 劍仙飛在天上怎麼可能中陷阱
[h3]其他基本資訊[/h3]
有信仰改為無信仰 痲瘋劍仙只相信力量！
暴擊效果：+1動作，-10%暴擊(1回合) 我的回合還是我的回合！
反擊：100基礎精準/-40%傷害修正/+0%暴擊修正，眩暈(100%)
[spoiler]我說暴擊+1動反擊帶暈眩，反擊暴擊也能+1動你爾多龍嗎[/spoiler]
瀕死減益改為：癒合1/+25%閃避/+33%受到的壓力傷害 仙體無限再生，合理吧
任務開始時為藏鋒姿態，戰鬥結束不切換姿態
若戰鬥開始時為藏鋒姿態：+50%眩暈技能機率(直到戰鬥結束)
若戰鬥開始時為出鞘姿態：+5精準+2速度(直到戰鬥結束)
移動：最多前進3/後退3
...
目前只支援：English / 簡體中文
使用其他語言會顯示英文文本
在日本語和한국어中，一些專有名詞會顯示繁體中文文本

[img]https://images.steamusercontent.com/ugc/15785299668783149053/C6745BFF1EBF8DEA09B033B984C5ED6FF1BCB639/[/img]
如果有人願意為本模組製作專屬的皮膚，我將會推出獨立角色版本
如果有人願意為本模組製作翻譯或補全文本，我也會將其加入本模組的內容之中
這是本模組的GitHub連結：https://github.com/C-W-Z/dd_leper_sword_immortal
如果有任何需要加Steam好友或Discord聯繫的需求，請先在底下留言，因為我會忽略不認識的好友申請(本作者沒有QQ也懶得辦QQ，Discord比QQ好用一萬倍)

[img]https://images.steamusercontent.com/ugc/15337324264522088853/54F1ED408723FB3E78CBD6B02A1D407AAB2614E4/[/img]
[u][b]本模組及其內容不得以任何形式上傳至任何網站，冒充原開發者（Icya）。[/b][/u]

[u][b]本模組完全免費，任何收費模組都是違法的！[/b][/u]注意是任何遊戲的任何模組！ (只有官方DLC才有收費的權力)

允許以附加組件的形式(附加組件指的是要將本模組作為前置並同時啟用才有效的模組)發佈對本模組的任何平衡性調整/代碼編輯/視覺效果修改，但不得重新上傳包含您修改的整個模組。

[img]https://images.steamusercontent.com/ugc/14053696630928410592/0897F58FC6A43194943489F7DC3F62F3BB985800/[/img]
愛發電：https://ifdian.net/a/icya_io
