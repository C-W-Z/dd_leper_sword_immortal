...
闪避：20 > 30       剑仙御剑飞行，闪避攻击轻而易举
防御：0% > 0%       穿重装都没防御，脱下也自然没防御
速度：4 > 10        剑仙御剑飞行，奇快无比
精准：0 > 0         仙剑攻击难以闪躲(详见技能基础精准)
暴击：5% > 5%       太超模了不能再加暴击了
伤害：13-26 > 20-26 仙剑剑身各处几乎一样锋利
[h3]初始抗性 原版麻风vs麻风剑仙[/h3]
晕眩：60% > 80%  仙人的意志力无比强大
腐蚀：40% > 50%  仙体百毒不侵！某些奇毒例外
流血：10% > 10%  仙人依然有血有肉，还是会流血
疾病：20% > 90%  仙体百病不侵！
位移：60% > 0%   站在飞剑上当然没有位移抗性
减益：40% > 20%  仙人也会中魔法
致死：67% > 67%
陷阱：10% > 110% 剑仙飞在天上怎么可能中陷阱
[h3]其他基本资讯[/h3]
有信仰改为无信仰 麻风剑仙只相信力量！
暴击效果：+1动作，-10%暴击(1回合) 我的回合还是我的回合！
反击：100基础精准/-40%伤害修正/+0%暴击修正，眩晕(100%)
[spoiler]我说暴击+1动反击带晕眩，反击暴击也能+1动你尔多龙吗[/spoiler]
濒死减益改为：愈合1/+25%闪避/+33%受到的压力伤害 仙体无限再生，合理吧
任务开始时为藏锋姿态，战斗结束不切换姿态
若战斗开始时为藏锋姿态：+50%眩晕技能机率(直到战斗结束)
若战斗开始时为出鞘姿态：+5精准+2速度(直到战斗结束)
移动：最多前进3/后退3
...
如果有人愿意为本模组制作翻译或补全文本，我也会将其加入本模组的内容之中
这是本模组的GitHub连结：https://github.com/C-W-Z/dd_leper_sword_immortal
如果有任何需要加Steam好友或Discord联系的需求，请先在底下留言，因为我会忽略不认识的好友申请(本作者没有QQ也懒得办QQ，Discord比QQ好用一万倍)

[img]https://images.steamusercontent.com/ugc/15337324264522088853/54F1ED408723FB3E78CBD6B02A1D407AAB2614E4/[/img]
[u][b]本模组及其内容不得以任何形式上传至任何网站，冒充原开发者（Icya）。[/b][/u]

[u][b]本模组完全免费，任何收费模组都是违法的！[/b][/u]注意是任何游戏的任何模组！ (只有官方DLC才有收费的权力)

允许以附加组件的形式(附加组件指的是要将本模组作为前置并同时启用才有效的模组)发布对本模组的任何平衡性调整/代码编辑/视觉效果修改，但不得重新上传包含您修改的整个模组。
